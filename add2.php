<?php
            ...
            <style>
             ...
             <table border"0" bgcolor="yellowyellow" align="center" cellspacing="20">
                <tr>
             <td>Product ID</td>
            ...
            $p=$_GET['productprice'];
            $stt=$_GET['status'];
            $query = "INSERT INTO shop2 VALUES ('$id','$n','$p','$stt')";
            $data = pg_query($pg_conn,$query);
            if($data)
            {
            echo "<script>alert('Added Successfully!')</script>";
            ?>
            <meta http-equiv="refresh" content="2; url=https://fptapptech.herokuapp.com/shop2.php">
            <?php
            }
            else
            {
